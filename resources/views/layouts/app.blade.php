...
<body class="bg-slate-50 text-slate-900">
   ...
   <!-- Footer -->
<footer class="bg-slate-900 text-slate-300 py-10 px-6 mt-16 border-t border-slate-200">
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-white font-bold text-sm mb-3 uppercase tracking-wider">Navigasi</h4>
            ...
            <!-- Contact -->
            <div>
                <h4 class="text-white font-bold text-sm mb-3 uppercase tracking-wider">Kontak</h4>
                <ul class="space-y-2 text-sm">
                    <li>

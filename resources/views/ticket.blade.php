...
<style>
    @media print {
        /* Sembunyikan Navbar, Footer, dan Tombol */
        nav, footer, .no-print {
        ...
        /* Hilangkan background gradient ungu di halaman */
        .bg-gradient-to-br {
            background: white !important;
        ...
        /* Rapikan Tampilan Tiket saat di-print */
        .bg-white.rounded-3xl {
            box-shadow: none !important;
            border: 2px dashed #cbd5e1 !important;
            margin: 0 auto !important;
            max-width: 600px !important;
            page-break-inside: avoid; /* Mencegah tiket terpotong di tengah */
        }

        /* Hilangkan efek hover/transform */
        * {
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-6">
            ...
            <div class="text-center">
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider 
                    @if(in_array($statusLower, ['success', 'settlement'])) bg-green-100 text-green-700 border-2 border-green-200
                    @elseif($statusLower === 'pending') bg-yellow-100 text-yellow-700 border-2 border-yellow-200
            ...
            <div class="px-8 pb-8 space-y-3 no-print">
                @if(in_array($statusLower, ['success', 'settlement']))
                    <!-- Tombol Cetak HANYA untuk yang sudah bayar -->

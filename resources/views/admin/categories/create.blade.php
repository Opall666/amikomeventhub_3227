...
@section('page_subtitle', 'Buat kategori untuk mengelompokkan event Anda.')
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" 
                placeholder="Contoh: Seminar IT, Musik, Workshop"
            ...
            @enderror
            <p class="text-xs text-slate-400 mt-2">Slug akan otomatis dibuat dari nama kategori.</p>
        </div>

...
<body class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <!-- Demo Credentials -->
        <div class="mt-6 bg-white/50 backdrop-blur rounded-2xl p-4 border border-slate-200">
            <p class="text-xs text-slate-500 text-center mb-2 font-bold uppercase tracking-wide">Demo Credentials</p>
            <div class="grid grid-cols-2 gap-2 text-xs">
                <div class="bg-slate-50 p-2 rounded-lg">
                    <p class="font-bold text-slate-700">Admin</p>
                    <p class="text-slate-500">admin@amikom.ac.id</p>
                    <p class="text-slate-500">password</p>
                </div>
                <div class="bg-slate-50 p-2 rounded-lg">
                    <p class="font-bold text-slate-700">User</p>
                    <p class="text-slate-500">john@example.com</p>
                    <p class="text-slate-500">password</p>
                </div>
            </div>
        </div>
